...
companies:
  - name: VMware Carbon Black
    ...
    additionalInfo:
      - title: Hardening
        body: detecting misconfigurations in Kubernetes resources and enforcing policies for them
      - title: Image Scanning
        body: scanning container images, integrated with Hardening, ability to block images from being deploy depending on the number of vulnerabilities
      - title: Runtime
        body: runtime monitoring and protection, detecting anomalies in network activity during the runtime lifecycle of the app
    responsibilities:
  ...
  - name: Docker Inc./ Mirantis Inc.
    ...
    additionalInfo:
      - title: SaaS multi-cluster management product
        body: part of Docker EE stack. Scrapped after the acquisition.
      - title: Universal Control Plane (UCP)
        titleLink: https://www.mirantis.com/software/mirantis-kubernetes-engine/
        body: Integrating Istio Ingress into UCP - Kubernetes/Swarm distro, part of Docker EE
      - title: Launchpad
        titleLink: https://docs.mirantis.com/mke/3.5/launchpad.html
        body: CLI tool for installing Docker EE products
