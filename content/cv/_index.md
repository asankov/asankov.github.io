...
companies:
  - name: Cast AI
    ...
    info: |
      <div> At Cast AI I am working on the Security product, part of the Cast Automation Platform.
      Features of the Security producy include:
      </div>
      <ul>
        <li> <span class="bold">Attack Paths</span>: graph-based detection of attack vectors exposed and waiting to be exploited </li>
        <li> <span class="bold">Image Scanning</span>: scanning container images, providing information about vulnerable container images and possible remediation </li>
        <li> <span class="bold">Compliance</span>: rule-based checks for violation of industry-defined compliance standards and best practices </li>
      </ul>
    responsibilities:
    ...
    tech: Go, gRPC, eBPF, Kubernetes, Helm, PostgreSQL, Terraform, GCP PubSub
    list:
      ...
      - client-side components running in the customers' clusters - an agent that performs image scanning, cluster checks and runtime protection
